    ...
    f.prototype = {
        ...
        createLi: function() {
            ...
            return this.$element.find("option").each(function() {
                var c = a(this)
                  ...
                  , n = c[0].index;
                if ("" !== l && m && (l = "<span>" + l + "</span>"),
                c.data("content") || (j = l + '<span class="text">' + j + k + "</span>"),
        ...
        liveSearchListener: function() {
            ...
            this.$searchbox.on("input propertychange", function() {
                ...
                b.$menu.find("li").filter(":visible:not(.no-results)").length ? e.parent().length && e.remove() : (e.parent().length && e.remove(),
                e.html(b.options.noneResultsText + ' "' + d(b.$searchbox.val()) + '"').show(),
                b.$menu.find("li").last().after(e))) : (b.$lis.not(".is-hidden").removeClass("hide"),
                e.parent().length && e.remove()),
        ...
        keydown: function(b) {
            ...
            d.length) {
                if (/(38|40)/.test(b.keyCode.toString(10)))
                    ...
                    r != p[b.keyCode] ? (q = 1,
                    a(document).data("keycount", q)) : q >= s.length && (a(document).data("keycount", 0),
                    q > s.length && (q = 1)),
                    d.eq(s[q - 1]).focus()
                }
